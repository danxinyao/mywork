$(window).ready(function() {
   (function(){
    var d;
    var c=0;
    function b(){$("#slide_three .warp .point span").removeClass("visible");$("#slide_three .warp .fig img").fadeOut("slow")
    };
   ...
   $("#slide_three .warp #left").click(function() {
        ...
        if(c==5) { c=0}
        b();
        $($("#slide_three .warp .fig img")[c]).fadeIn("slow",a());$($("#slide_three .warp .point span")[c]).addClass("visible")
    });
    function a() { d=setInterval(function(){c++;if(c==5){c=0};
    b();
    $($("#slide_three .warp .fig img")[c]).fadeIn();
    $($("#slide_three .warp .point span")[c]).addClass("visible")},2000)};
    a();
   })();   
});
(function(){
